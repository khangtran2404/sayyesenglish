...
$id_page = get_queried_object()->ID; ?>
    <div class="template-service">
        ...
        <div class="banner-top-provider" style="background-image: url('<?= $banner_top_provider['background_banner']['url']; ?>')">
            <div class="group-content">
                <div class="container">
                    <div class="content">
                ...
                <div class="container">
                    ...
                    <div class="service-item">
                        <div class="group-heading <?= $array_align[$condition];?> wow animate__fadeInUp">
                            <h2>
                                <span class="number"><?php if($count<10){ echo'0';}?><?= $count;?>.</span><?= $group['title'] ?>
                            </h2>
                        </div>
                        <?php if($group['posts']):?>
                        <div class="post-list">
                            ...
                            class="service-post-item wow animate__fadeInUp" data-wow-delay="1s">
                                ...
                                <div class="button-volcano">
                                    <span class="arrow-line">
                                        <img width="15" src="<?= DF_IMAGE .'/arrow-line-right.png'?>" alt="icon arrow">
                                    </span>
        ...
        <button type="button" class="btn btn-primary hidden show-service-popup-btn" data-toggle="modal" data-target="#exampleModalCenter">
            Launch demo modal
        </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body service-post-popup-body row">
                        ...
                        <div class="col-md-6 col-sm-12 service-post-content">
                            <div class="group-content">
                                <div class="icon">
                                    <img height="65" src="<?=  get_field('banner_top_service_provider', $id_page)['icon_quote']['url']?>" alt="icon">
                                </div>
